...
st.header(":blue[Visulization and forecasting of stocks using python and ML]")
#st.color_picker(black)
#st.markdown("Guide: Prof. R.R.Patel")
#st.markdown("By: Devendra joshi, Aniket Patil, Prajakta yeole, Dhanashri wani")
#st.image("")
...
with st.sidebar:
    st.markdown(":green[About Developers]:")
    st.markdown("project developed by: Devendra Joshi, Aniket patil, Prajakta Yeole, Dhanashri Wani")
    st.markdown(":green[Guide]:")
    st.markdown("Prof.R.R.Patel")
